...
namespace ProSolutionFormsAPI.Migrations
{
    ...
    [Migration("20250410123511_Add InterviewFormHE Data Model")]
    partial class AddInterviewFormHEDataModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProSolutionFormsAPI.Models.InterviewHEModel", b =>
                {
                    ...
                    b.Property<bool?>("ApplicantIsAwareOfTuitionFee")
                        .HasColumnType("bit");

                    b.Property<bool?>("ApplicantUnderstandsStructureOfCourse")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("LastEducationalEstablishmentAttended")
                        .HasColumnType("nvarchar(max)");
