...
namespace ProSolutionFormsAPI.Migrations
{
    ...
    [Migration("20250107160638_Add NoOffencesToDeclare to Criminal Convictions Model")]
    partial class AddNoOffencesToDeclaretoCriminalConvictionsModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProSolutionFormsAPI.Models.CriminalConvictionOffenceModel", b =>
                {
                    ...
                    b.ToTable("CriminalConvictionOffenceModel");
                });
